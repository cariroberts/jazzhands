...
#we need to pull the publication date by doing an additional API call for 
     system("curl -L --request GET 'https://api-eu.hosted.exlibrisgroup.com/almaws/v1/bibs/$mmsID?view=full&expand=None&apikey=l7xxa730c5d8d8844676ab5e1607d1161322' > ./tempbib.xml");  

    my $itemdoc = $parser->parse_file("./tempbib.xml");
    $pubdate = "";
