...
#world's third-worst Perl documented script
#
#in-line notes think of nothing but commentary all day

#for this script, we assume we're working with a file of tab-delimited stuff, so we want to make sure a filename is relayed to it

#this line basically captures the first argument specified when running the script
